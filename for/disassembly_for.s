...
for.o:     file format elf32-littlearm
for.o
...
Idx Name          Size      VMA       LMA       File off  Algn
  ...
  4 .comment      00000044  00000000  00000000  0000008c  2**0
                  CONTENTS, READONLY
  5 .ARM.attributes 0000002a  00000000  00000000  000000d0  2**0
                  CONTENTS, READONLY
SYMBOL TABLE:
00000000 l    df *ABS*	00000000 for.c
...
00000000 <main>:
   ...
   c:	e3a03000 	mov	r3, #0 //k=0
  10:	e50b3008 	str	r3, [fp, #-8] 
  14:	ea000005 	b	30 <main+0x30> 
  18:	e51b1008 	ldr	r1, [fp, #-8] 
  1c:	e59f002c 	ldr	r0, [pc, #44]	@ 50 <main+0x50> //tải địa chỉ của chuỗi định dạng "%d\n" vào r0
  20:	ebfffffe 	bl	0 <printf>
			20: R_ARM_CALL	printf
  24:	e51b3008 	ldr	r3, [fp, #-8]
  28:	e2833001 	add	r3, r3, #1
  2c:	e50b3008 	str	r3, [fp, #-8]
  30:	e51b3008 	ldr	r3, [fp, #-8] 
  34:	e3530004 	cmp	r3, #4 
  38:	dafffff6 	ble	18 <main+0x18>// nếu k <= 4 thì nhảy về địa chỉ 18 để in ra giá trị của k
  ...
  50:	00000000 	andeq	r0, r0, r0
			50: R_ARM_ABS32	.rodata

Disassembly of section .rodata:

00000000 <.rodata>:
   0:	000a6425 	andeq	r6, sl, r5, lsr #8 //địa chỉ của chuỗi định dạng "%d\n"
